    ...
    <div>
      <div
        className={classNames(
          "aspect-square relative rounded-full overflow-hidden w-40 grid hover:cursor-pointer hover:bg-blue-100 content-center border-slate-300 border-2 border-dashed",
